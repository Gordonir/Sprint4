...
public class OrderSamokatDownButtonMozillaTest  {
    ...
    private String date;
    private String days; // Добавлено поле для количества суток
    private String color; // Добавлено поле для цвета самоката
    private String comment; // Добавлено поле для комментария

    public OrderSamokatDownButtonMozillaTest (String name, String family, String address, String metro, String phone, String date, String days, String color, String comment) {
        this.name = name;
        this.family = family;
        ...
        this.phone = phone;
        this.date = date;
        this.days = days; // Инициализация поля days
        this.color = color; // Инициализация поля color
        this.comment = comment; // Инициализация поля comment
    }
    ...
    public void testOrderScooterPositiveFlow() {
        // 1. Кликнуть на кнопку "Заказать" (нижняя)
