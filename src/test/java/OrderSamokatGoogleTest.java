...
public class OrderSamokatGoogleTest {
    ...
    public OrderSamokatGoogleTest(String name, String family, String address, String metro, String phone, String date, String days, String color, String comment) {
        this.name = name;
        this.family = family;
    ...
    public void testOrderScooterPositiveFlow() {
        //  Кликнуть на кнопку "Заказать" (верхняя)
